...
contract DiamondFullUpgrade is Script {
    function run() external {
        ...
        // Four function signatures changed selectors — old must be removed, new added.
        // cancelTask:        (bytes32)            -> (bytes32,uint256)
        // refundExpired:     (bytes32)            -> (bytes32,uint256)
        // acceptSubmission:  (bytes32,address,bytes32) -> (bytes32,address,bytes32,uint256)
        // acceptSubmissions: (bytes32,address[],uint16[],bytes32[]) -> (bytes32,address[],uint16[],uint256)
        // taskSubmissionHashes: new getter on RegistryFacet
        ...
        // CoreFacet — all 21 selectors (including cancelTask, refundExpired, rejectSubmission)
        ...
        coreSelectors[17] = CoreFacet.updateTask.selector;
        coreSelectors[18] = CoreFacet.rejectSubmission.selector;
        coreSelectors[19] = CoreFacet.cancelTask.selector;
        ...
        // AcceptanceFacet — both selectors now have their new signatures on this diamond
        ...
        // RegistryFacet — all 22 selectors including taskSubmissionHashes
        bytes4[] memory regSelectors = new bytes4[](22);
        ...
        regSelectors[21] = RegistryFacet.taskSubmissionHashes.selector;
